...
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The spring-boot-forge-addon addon enables blah blah...)
...
----
<dependency>
   <groupId>org.spring.boot.forge.addon</groupId>
   <artifactId>spring-boot-forge-addon</artifactId>
